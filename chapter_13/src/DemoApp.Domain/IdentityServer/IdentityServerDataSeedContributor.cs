...
namespace DemoApp.IdentityServer;
...
public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        await CreateApiScopeAsync("DemoApp");
    }
    ...
    private async Task CreateApiResourcesAsync()
    {
        ...
        await CreateApiResourceAsync("DemoApp", commonApiUserClaims);
    }
    ...
    private async Task CreateClientsAsync()
    {
        ...
        {
            var webClientRootUrl = configurationSection["DemoApp_App:RootUrl"]?.TrimEnd('/');
        ...
        {
            var blazorRootUrl = configurationSection["DemoApp_Blazor:RootUrl"].TrimEnd('/');
